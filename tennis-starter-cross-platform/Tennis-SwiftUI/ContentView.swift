...
struct TennisScoreboardView: View {
    ...
    var p1NameBackground: Color {
        match.player1Serving() ? .purple : .clear
    }

    var p2NameBackground: Color {
        match.player2Serving() ? .purple : .clear
    }
    ...
    func p1AddPoint(){
        let gamesBefore = match.currentSet.p1Games
        
        match.addPointToPlayer1()
        
        if match.currentSet.p1Games > gamesBefore {
            alertMessage = "Player 1 won the game"
            showAlert = true
        }
    ...
    func p2AddPoint(){
        let gamesBefore = match.currentSet.p2Games
        
        match.addPointToPlayer2()
        
        if match.currentSet.p2Games > gamesBefore {
            alertMessage = "Player 2 won the game"
            showAlert = true
        }
